...
The script intentionally reads paths from environment variables/arguments. It
copies BACKUP_LATEST_CSV (or --source) to a timestamped file under BACKUP_OUTPUT_DIR
(or --output-dir). It does not contain site-specific paths or secrets.
"""
