...
const envSchema = z.object({
  ...
  ZEBRA_LABEL_HEIGHT_DOTS: z.coerce.number().int().positive().default(96),
  ZEBRA_LABEL_OFFSET_X: z.coerce.number().int().nonnegative().default(0),
  ZEBRA_LABEL_OFFSET_Y: z.coerce.number().int().nonnegative().default(0),
  ZEBRA_TEXT_X: z.coerce.number().int().nonnegative().default(0),
  ZEBRA_TEXT_WIDTH_DOTS: z.coerce.number().int().positive().default(240),
  ZEBRA_FONT_LINE1_HEIGHT: z.coerce.number().int().positive().default(14),
  ZEBRA_FONT_LINE1_WIDTH: z.coerce.number().int().positive().default(14),
  ZEBRA_FONT_LINE2_HEIGHT: z.coerce.number().int().positive().default(14),
  ZEBRA_FONT_LINE2_WIDTH: z.coerce.number().int().positive().default(14),
  ZEBRA_FONT_LINE3_HEIGHT: z.coerce.number().int().positive().default(12),
  ZEBRA_FONT_LINE3_WIDTH: z.coerce.number().int().positive().default(12),
  ZEBRA_LINE1_Y: z.coerce.number().int().nonnegative().default(4),
  ZEBRA_LINE2_Y: z.coerce.number().int().nonnegative().default(30),
  ZEBRA_LINE3_Y: z.coerce.number().int().nonnegative().default(56),
