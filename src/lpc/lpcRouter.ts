...
export function createLpcRouter(options: {
  ...
  router.get('/status', (_req, res) => {
    ...
    res.json({
      ...
      lastInterfaceError: state.lastInterfaceError,
      lastInterfaceErrorAt: state.lastInterfaceErrorAt,
      lastInterfaceAttempt: state.lastInterfaceAttempt,
      usingFallbackInterface: state.usingFallbackInterface,
      fallbackEnabled: state.fallbackEnabled,
      fallbackInterfaces: state.fallbackInterfaces,
      lastInterfaceAttempts: state.lastInterfaceAttempts,
