...
function config(patch: Partial<SplunkRuntimeConfig> = {}): SplunkRuntimeConfig {
  return { enabled: true, url: 'https://splunk.example.local:8088/services/collector', token: 'token-for-test', index: 'i', source: 's', sourcetype: '_json', site: 'W16', line: 'PWT', workplace: 'LPC-528-01', device: 'LPC-528-01', timeoutMs: 1, verifyTls: true, sendResult: true, sendCurve: false, sendCurveSummary: true, curveSampleIntervalSec: 1, curveSampleMaxPoints: 120, bufferEnabled: true, bufferRetryIntervalMs: 1, bufferMaxAttempts: 0, streamPointsMode: 'full', streamPointsMax: 5000, includeRawStream: false, rawStreamMax: 1000, ...patch };
}
