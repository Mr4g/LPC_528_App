...
export function buildSplunkResultEnvelope(config: SplunkRuntimeConfig, context: SplunkResultContext): SplunkHecEnvelope {
  ...
  return {
    ...
    event: {
      ...
      dptPointCount,
      curveSummary,
      limits: result.limits ?? { cachedAtStart: result.cachedLimitsAtStart ?? null, fromResult: null, changedDuringTest: null },
      limitCheck: result.limitCheck ?? null,
      masterSample: result.masterSample ?? { enabled: false },
...
export function buildSplunkErrorEnvelope(config: SplunkRuntimeConfig, context: SplunkErrorContext): SplunkHecEnvelope {
  ...
  return {
    ...
    event: {
      ...
      FPR: null,
      FPR_unit: null,
      limits: { cachedAtStart: null, fromResult: null, changedDuringTest: null },
      limitCheck: null,
      masterSample: { enabled: false },
